                                    ...
                                    child: Card(
                                      ...
                                      child: Container(
                                        ...
                                        child: value[index]["cycle"] != null ? ListTile(
                                          ...
                                          title: Text('${ value[index]["plant"].name}',style: TextStyle(fontSize: 14)),
                                          ...
                                          child: Column(
                                            children: [
                                              ListTile(
                                                ...
                                                title: Text(value[index]["timelines"]["title"],style: TextStyle(fontSize: 14),),
                                                          ...
                                                          return CupertinoAlertDialog(
                                                            ...
                                                            actions: [
                                                              ...
                                                              CupertinoDialogAction(isDefaultAction: false, child: const Text("확인",style: TextStyle(color: Colors.red),),
                                                                  onPressed: () async {
                                                                    if(value[index]["timelines"]["image"] != null){
